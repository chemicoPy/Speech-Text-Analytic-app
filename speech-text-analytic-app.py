...
"""Remove below comment to clone from my github repo: chemicopy"""

# ! git clone https://github.com/chemicoPy/Speech-Text-Analytic-app.git
...
# re-configuring page layout to restrict users from overwriting the app configuration
...
# ------- audio to text ----------------------------------------------------
    ...
    st.sidebar.markdown(
     ...
     ----------
    ## Project Overview
    This is an AI web app that transcribes text to speech & speech to text in 6 different languages, extracts specific features in the 
    ...
    if demo == 1:
       st.sidebar.video('https://res.cloudinary.com/victorogunjobi/video/upload/v1656670610/samples/Text-Speech-Analytic%20app/app_demo_qaoft2.mp4', format='mp4')
    ...
    """)
     ...
     #----- deleting files from directories so that the app is not overloaded------
